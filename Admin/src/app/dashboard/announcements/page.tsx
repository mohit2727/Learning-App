                                        ...
                                        <div className="flex flex-col md:flex-row gap-5">
                                            {announcement.image && (
                                                <div className="w-full md:w-28 h-20 rounded-xl overflow-hidden flex-shrink-0 border border-slate-100 shadow-sm">
                                                    <img src={announcement.image.startsWith('http') ? announcement.image : `${process.env.NEXT_PUBLIC_BACKEND_BASE_URL || ''}${announcement.image}`} alt="" className="w-full h-full object-cover" />
                                                </div>
                                            )}
